...
def init_board() -> list[list]:
	board = [
		[Rook('black', 1), Knight('black', 1), Bishop('black', 1), Queen('black', 1), King('black', 1), Bishop('black', 2), Knight('black', 2), Rook('black', 2)],
		...
		[Rook('white', 1), Knight('white', 1), Bishop('white', 1), Queen('white', 1), King('white', 1), Bishop('white', 2), Knight('white', 2), Rook('white', 2)]
	]
	return (board)