...
def put_background(screen, letter_font) -> None:
    ...
    surface = letter_font.render('8', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (25,100)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('8', True, LETTER_COLOR), (20, 85))
    surface = letter_font.render('7', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (25,200)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('7', True, LETTER_COLOR), (20, 185))surface = letter_font.render('8', True, LETTER_COLOR)
    surface = letter_font.render('6', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (25,300)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('6', True, LETTER_COLOR), (20, 285))surface = letter_font.render('8', True, LETTER_COLOR)
    surface = letter_font.render('5', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (25,400)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('5', True, LETTER_COLOR), (20, 385))surface = letter_font.render('8', True, LETTER_COLOR)
    surface = letter_font.render('4', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (25,500)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('4', True, LETTER_COLOR), (20, 485))surface = letter_font.render('8', True, LETTER_COLOR)
    surface = letter_font.render('3', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (25,600)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('3', True, LETTER_COLOR), (20, 585))surface = letter_font.render('8', True, LETTER_COLOR)
    surface = letter_font.render('2', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (25,700)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('2', True, LETTER_COLOR), (20, 685))surface = letter_font.render('8', True, LETTER_COLOR)
    surface = letter_font.render('1', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (25,800)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('1', True, LETTER_COLOR), (20, 785))surface = letter_font.render('8', True, LETTER_COLOR)


    surface = letter_font.render('a', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (100,875)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('a', True, LETTER_COLOR), (85, 865))
    surface = letter_font.render('b', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (200,875)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('b', True, LETTER_COLOR), (185, 865))
    surface = letter_font.render('c', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (300,875)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('c', True, LETTER_COLOR), (285, 865))
    surface = letter_font.render('d', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (400,875)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('d', True, LETTER_COLOR), (385, 865))
    surface = letter_font.render('e', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (500,875)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('e', True, LETTER_COLOR), (485, 865))
    surface = letter_font.render('f', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (600,875)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('f', True, LETTER_COLOR), (585, 865))
    surface = letter_font.render('g', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (700,875)
    screen.blit(surface, rect)
    # screen.blit(letter_font.render('g', True, LETTER_COLOR), (685, 865))
    surface = letter_font.render('h', True, LETTER_COLOR)
    rect = surface.get_rect()
    rect.center = (800,875)
    screen.blit(surface, rect)
